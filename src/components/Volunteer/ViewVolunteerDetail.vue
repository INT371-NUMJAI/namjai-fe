<template>
  <div class="mx-[30px] md:mx-24 lg:mx-44 lg:grid lg:grid-cols-12 lg:gap-[30px] my-10 lg:my-[60px] mt-[120px] lg:mt-0">
    <div name="detail" class="lg:col-span-8 lg:mt-[120px]">
      <div class="grid grid-cols-1 mb-[20px] text-sm lg:text-base font-medium">
        <div class="space-x-2">
          หมวดหมู่:
          <div class="inline-block" v-for="category in volunteer.targetCategoriesSet" :key="category">
            <p class="text-namjaigreen ">
      ...
      <img v-if="volunteer.picturePath != null" class="w-full aspect-video object-cover my-5 lg:my-[30px]" :src="getImage(volunteer.picturePath)" />
      <img v-else-if="volunteer.picturePath === null" class="w-full aspect-video object-cover my-5 lg:my-[30px]" src="@/assets/image-unavailable.jpeg" />
        ...
        <div class="space-y-3 mt-[60px] lg:hidden">
          <div class="grid grid-rows-2 grid-cols-2">
            ...
            <div class="justify-self-end mr-7">
              <svg class="cursor-pointer" v-if="!checkFav" @click="
    ...
    <div name="regist" class="h-full lg:h-full lg:col-span-4 bg-white my-[30px] lg:my-0 py-[30px] px-6 text-namjaidarkgray lg:flex lg:justify-center">
      <div class="lg:my-24 lg:mx-auto">
