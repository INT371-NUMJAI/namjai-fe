<template>
    ...
    <div class="my-[60px] space-y-10">
      ...
      <div name="search" class="flex justify-center text-gray-600 items-center">
        <input class="w-full md:w-1/2 lg:w-1/3 h-10 px-5 rounded-lg text-sm drop-shadow-md placeholder:italic placeholder:text-slate-400 bg-white ring-1 ring-slate-300 hover:ring-2 hover:ring-emerald-500 focus:outline-none focus:border-namjaigreen focus:ring-namjaigreen focus:ring-2" type="search" name="search" placeholder="ใส่ชื่อโครงการจิตอาสาเพื่อค้นหา" />
