<template>
	<nav
		class="bg-orange-500 flex items-center justify-between px-7 py-6 lg:py-4 lg:px-11 drop-shadow-md lg:fixed lg:w-screen"
	>
		...
		<div class="hidden lg:flex lg:space-x-11 items-center text-white lg:text-base">
			<router-link to="/admin-management">
				<w-button bg-color="transparent" class="font-medium">จัดการ</w-button></router-link
			>
