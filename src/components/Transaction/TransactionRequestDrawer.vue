    ...
    <w-drawer v-model="showDrawer" bg-color="namjaigreen" width="590" class="z-50">
      ...
      <div class="w-full mx-10 mt-12">
        ...
        <w-form class="mt-10">
          ...
          <w-select outline :items="province" color="black" class="h-[40px] mt-5"></w-select>
          ...
          <div>
            ...
            <div class="items-center relative">
              <h2 class="text-lg">บัญชี</h2>
              <w-select outline :items="account" color="black" class="h-[40px] mt-5"></w-select>
              <button class="mt-[20px] w-full text-center text-sm py-2 px-4 bg-white relative hover:bg-gray-300 hover:text-white">
...
export default {
  setup() {
    ...
    return { showDrawer, showAccount, showAddAccount, province, account };
  },
};
</script>
