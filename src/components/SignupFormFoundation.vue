  ...
  <div class="mt-10">
    <w-form v-model="valid" name="foundationForm" class="hidden lg:inline">
      <div class="space-y-10 pb-10 pt-[30px]">
        ...
        <h1 class="pt-[30px] text-[20px] text-namjaigreen">
          ข้อมูลที่อยู่องค์กร
        </h1>
        <div class="space-y-4">
      ...
      <div
        class="md:mx-auto mx-auto flex justify-center mt-1 mb-5 bg-namjaigreen h-[60px] w-80 my-10 rounded-xl"
      >
        <w-button
