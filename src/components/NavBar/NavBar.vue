<template>
  <nav class="bg-namjaigreen grid grid-cols-12 fixed items-center justify-between px-7 py-6 lg:py-4 lg:px-11 drop-shadow-md lg:fixed lg:w-screen md:w-screen">
    <div class="flex items-center text-white space-x-5 lg:col-span-5 col-span-11 md:col-span-11">
      <router-link to="/main">
