    ...
    >
      ...
      <div>
        ...
        <span v-if="use_auth.store_auth.user !== null">
          ...
          <div>
            <div
              class="absolute mt-2 -ml-[21px] z-10 bg-white"
              v-if="showDropDown"
            >
              <div class="text-white font-medium">
                ...
                <w-button
                  color="red"
                  bg-color="transparent"
                  class="block text-sm ml-[35px] my-2"
                  @click="clicktoLogout"
                  >ลงชื่อออก</w-button
                >
              </div>
...
export default {
  ...
  setup() {
    ...
    return { use_auth, showDropDown, clicktoLogout, routeToProfile, checkLoginStatus };
  },
};
</script>
<style>
