    ...
    <w-form v-model="valid" class="hidden lg:inline" @success="submitForm">
      <div class="space-y-10 pb-10 pt-[30px]">
        ...
        <div class="grid grid-cols-2 gap-10">
		  ...
		  <div class="space-y-4">
            <label class="font-medium">ชื่อองค์กร(English)</label>
            <w-input :validators="[validators.required]" color="black" placeholder="Foundation name" v-model="foundation.fdnName"></w-input>
          </div>
        </div>
