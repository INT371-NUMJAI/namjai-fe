<template>
  <div class="">
    <div id="sec1" class="lg:mx-[177px] lg:mt-[146px] lg:mb-[80px]">
      <img class="object-cover w-full h-[770px] lg:w-[1086px] lg:h-[460px] lg:rounded-[20px]" src="@/assets/pic3.png" />
    </div>
    ...
    <div id="sec2" class="bg-[#FFFCF4] pt-[30px] md:pt-[60px] lg:pt-[60px]">
      <div class="mx-[30px] md:mx-[40px] lg:mx-[177px]">
        ...
        <div class="pt-[30px] md:pt-10 lg:pt-10 space-y-[30px]">
    ...
    <div id="sec5">
      <div class="mx-[30px] md:mx-[40px] lg:mx-[177px] py-[30px] md:py-0 md:pt-[60px] md:pb-[30px] lg:py-[60px] lg:grid lg:grid-cols-12 lg:gap-[30px]">
        <img class="object-cover md:w-[623px] lg:w-[714px] lg:h-[408px] lg:col-span-8 md:mx-auto" src="@/assets/sec5.png" />
