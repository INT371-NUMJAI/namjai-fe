<template>
	<div class="mx-[30px] md:mx-24 lg:mx-44">
		...
		<div class="flex overflow-x-auto space-x-3">
			<div v-for="targetCat in targetList" :key="targetCat.targetCategoriesID" class="bg-white hover:text-white hover:bg-namjaigreen w-[100px] h-[136px] py-[10px] rounded-lg mb-[60px] drop-shadow-md hover:shadow-md">
				<div>
...
export default {
	...
	setup() {
		...
		return { fdnProjectList, targetList };
	},
};
</script>
