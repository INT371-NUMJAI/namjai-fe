		...
		<div class="lg:mx-[183px] lg:mt-[60px]">
			<w-form v-model="valid">
				...
				<div class="flex space-x-[20px] lg:space-x-[30px]">
					<w-select class="mb-10 lg:text-base md:text-base text-sm lg:w-[300px]" :items="categories" label="ประเภทกิจกรรม" label-color="black" placeholder=" " selection-color="grey" color="black" return-object multiple v-model="fdnProjectBody.targetCategoriesSet">
				...
				<!-- {{ fdnProjectBody }}
        {{ fileUpload }} -->
				<base-button class="w-[140px] mx-auto mt-[60px] mb-8" buttonLabel="ยืนยัน" :isValid="valid === false" @click="submitProjectForm" />
			</w-form>
		</div>
	</div>
</template>
