<template>
  <div class="mx-[30px] md:mx-[40px] lg:mx-44 lg:grid lg:grid-cols-12 lg:gap-[30px] my-10 lg:my-0">
    <div class="lg:col-span-8 lg:mt-[120px]">
      ...
      <div class="bg-white mt-[30px] lg:mt-[40px]">
        <div class="flex justify-center md:justify-start lg:justify-start space-x-8 md:space-x-12 lg:space-x-12 text-sm lg:text-base md:px-8 lg:px-10">
          <div class="flex-wrap space-y-3 pt-4 lg:pt-6 h-[54px] lg:h-[66px]" @click="(selectedDetail = !selectedDetail), (selectedProgression = false), (selectedFinancialPlan = false)">
            ...
            <div class="h-1.5 bg-emerald-600" v-if="selectedDetail == false"></div>
          </div>
          <div class="flex-wrap space-y-3 pt-4 lg:pt-6 h-[54px] lg:h-[66px]" @click="(selectedProgression = !selectedProgression), (selectedDetail = false), (selectedFinancialPlan = false)">
            <h2 class="cursor-pointer select-all selection:text-namjaigreen">ความคืบหน้า</h2>
            <div class="h-1.5 bg-emerald-600" v-if="selectedProgression == false"></div>
          </div>
          <div class="flex-wrap space-y-3 pt-4 lg:pt-6 h-[54px] lg:h-[66px]" @click="(selectedFinancialPlan = !selectedFinancialPlan), (selectedDetail = false), (selectedProgression = false)">
            <h2 class="cursor-pointer select-all selection:text-namjaigreen">แผนการใช้เงิน</h2>
            <div class="h-1.5 bg-emerald-600" v-if="selectedFinancialPlan == false"></div>
          </div>
        </div>
      </div>
      ...
      <div name="content" class="bg-white text-sm lg:text-base rounded-b-md mb-[30px] lg:mt-0 lg:mb-[40px]">
        ...
        <div class="p-5 md:px-8 lg:px-10 md:py-6 lg:py-7 space-y-10">
          <div name="projectDetail" class="space-y-[30px]" v-if="selectedDetail == false">
            <div class="space-y-2">
              <h1>รายละเอียด</h1>
    ...
    <div name="donate" class="lg:col-span-4 lg:h-full bg-white text-sm lg:text-base rounded-md lg:rounded-none block lg:flex lg:justify-center">
      <div class="p-5 lg:mx-auto md:p-8 lg:my-24 lg:py-7 lg:px-0 lg:fixed">
        ...
        <div class="grid grid-cols-2 mb-5">
          ...
          <h1 class="text-2xl text-namjaigreen text-right">{{ project.received }}</h1>
        </div>
