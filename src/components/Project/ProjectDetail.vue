    ...
    <div class="lg:col-span-8 lg:mt-[120px]">
      ...
      <div class="bg-white mt-[30px] lg:mt-[40px]">
        ...
        >
          ...
          >
            ...
            <div
              class="h-1.5 bg-emerald-600"
              v-if="selectedProgression == false"
            ></div>
          </div>
          <div
            class="flex-wrap space-y-3 pt-4 lg:pt-6 h-[54px] lg:h-[66px]"
          ...
          >
            ...
            <div
              class="h-1.5 bg-emerald-600"
              v-if="selectedFinancialPlan == false"
            ></div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="p-5 md:px-8 lg:px-10 md:py-6 lg:py-7 space-y-10">
          ...
          <project-progression v-if="selectedProgression == false" />
          <project-financial-plan v-if="selectedFinancialPlan == false" />
      ...
      <div class="p-5 lg:mx-auto md:p-8 lg:my-24 lg:py-7 lg:px-0 lg:fixed">
        ...
        <div name="shareDt" class="hidden lg:block pt-16">
            ...
            <div class="flex space-x-3">
              ...
              <svg
                class="fill-current hover:text-[#10A88D] active:text-[#10A88D] cursor-pointer"
                width="38"
                height="38"
                viewBox="0 0 38 38"
                fill="none"
