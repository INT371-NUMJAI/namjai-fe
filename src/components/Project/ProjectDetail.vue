  ...
  <div class="mx-[30px] md:mx-24 lg:mx-44 mt-[50px] lg:mt-[120px]">
    ...
    >
      <div class="mx-[30px] py-[80px]">
        ...
        <!-- v-if="use_auth.store_auth.user.email === project.foundationContactDTO.email" -->
        <w-icon
            
            class="justify-self-end cursor-pointer"
            @click="showDialog = true; setFDNProjectUUID(project.foundationProjectUUID)"
            >fa fa-pencil-square-o</w-icon
          >
          <w-dialog width="450" v-model="showDialog">
    ...
    >
      <div class="mx-[20px] py-[20px] space-y-[30px]">
        ...
        <div v-if="project.picturePath" class="space-y-2">
          <h1>ติดต่อ</h1>
          <w-divider color="black"></w-divider>
          <p class="mb-[10px]">
            {{ formatFdnAddress }}
    ...
    <div
      name="donateMbTb"
      class="bg-white h-auto text-sm rounded-md mb-[30px] lg:hidden block"
    >
