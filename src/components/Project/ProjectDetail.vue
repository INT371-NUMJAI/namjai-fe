<template>
  <div class="mx-[30px] md:mx-24 lg:mx-44 mt-[50px] lg:mt-[120px]">
    <div class="flex space-x-2">
      <p>หมวดหมู่:</p>
      <p v-for="fdnProjectProp in fdnProjectProps.targetCategoriesSet" :key="fdnProjectProp" class="text-sm lg:text-base mb-[20px]">
    ...
    <img class="mb-[30px] lg:w-[700px] float-left mr-[30px]" :src="getImage(fdnProjectProps.picturePath)" />
    ...
    <div class="bg-white h-auto text-sm rounded-md mb-[30px] lg:mb-[40px] lg:w-[700px] lg:mt-[530px] mt-[270px] md:mt-[480px]">
      <div class="mx-[20px] py-[20px] space-y-[30px]">
        ...
        <div class="space-y-2">
          ...
          <p>
            {{ fdnProjectProps.foundationContactDTO.fdnName }}
            {{ fdnProjectProps.foundationContactDTO.addressDetail }} แขวง {{ fdnProjectProps.foundationContactDTO.subDistrict }} เขต
          ...
          <p class="pt-2">{{ fdnProjectProps.foundationContactDTO.contactNumber }}</p>
        </div>
