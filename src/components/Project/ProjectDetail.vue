  ...
  <div class="mx-[30px] md:mx-24 lg:mx-44 lg:grid lg:grid-cols-12 lg:gap-[30px] my-10 lg:my-0 mt-[120px] lg:mt-0">
    <div class="lg:col-span-8 lg:mt-[120px]">
      <div class="grid grid-cols-1 mb-[20px] text-sm lg:text-base font-medium">
        <div class="space-x-2">
          หมวดหมู่:
          <div class="inline-block" v-for="fdnProjectProp in project.targetCategoriesSet" :key="fdnProjectProp">
    ...
    <div name="donate" class="lg:col-span-4 lg:h-full lg:mt-0 bg-white text-sm lg:text-base rounded-md lg:rounded-none block lg:flex lg:justify-center">
