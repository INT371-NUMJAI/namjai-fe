<template>
  <div name="postdetailblock">
    <div class="grid grid-cols-5 md:grid-cols-10 lg:grid-cols-12 bg-namjaiwhite px-4 py-4 md:py-6 lg:px-6 lg:py-6 rounded-lg">
      ...
      <div class="col-span-4 md:col-span-9 lg:col-span-11 grid-flow-row space-y-2 md:space-y-3 lg:space-y-3 mt-1 lg:px-1 text-[14px] lg:text-[16px]">
        ...
        <img class="w-full aspect-video md:w-full md:h-[240px] lg:w-full lg:h-[278px] rounded-xl object-cover" src="@/assets/pic1.png" />
      </div>
    </div>
  </div>
</template>
