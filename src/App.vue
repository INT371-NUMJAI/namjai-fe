...
<template>
  <w-app>
    <nav
      class="bg-namjaigreen flex items-center justify-between px-7 py-3 md:py-3 md:px-11 drop-shadow-md"
    >
      ...
      <div
        class="hidden md:flex md:space-x-11 items-center text-white font-semibold"
      >
        ...
        <w-button bg-color="transparent" class="font-medium"
          >เกี่ยวกับเรา</w-button
        >
        <w-button
          bg-color="transparent"
          round
          outline
          class="py-4 bd4 font-medium"
    ...
    <div
      class="h-full w-full md:h-[850px] bg-namjaiwhite rounded-2xl lg:bg-transparent"
    >
      <div class="mx-8 mb-20 md:mx-20 lg:mx-44">
        <div class="flex justify-between">
          <span class="mt-10 text-2xl lg:text-5xl lg:mt-16 font-semibold"
            >เริ่มต้นเปลี่ยนสังคม</span
          >
          <div
            class="w-24 h-20 md:w-28 md:h-24 bg-namjaiyellow rounded-b-full lg:hidden"
          ></div>
        </div>
        <div
          class="w-16 border-4 border-t border-namjaired md:-mt-4 lg:mt-2"
        ></div>
        <div class="lg:grid lg:grid-cols-4 lg:gap-8 lg:mt-10">
          <div name="formContent" class="lg:col-span-3 lg:overflow-y-scroll">
            <div class="hidden lg:inline-flex lg:space-x-[60px] lg:mt-10">
              ...
              <div
                class="w-32 h-10 border border-namjaibrown rounded-md py-2 px-3 space-x-5"
              >
                <w-radio class="mr2" name="radio1" color="yellow"></w-radio>
                <span class="font-medium">มูลนิธิ</span>
              </div>
            </div>
            <w-form name="donorForm" class="py-7 lg:py-10">
              <div class="space-y-8 lg:space-y-10">
                <div
                  class="space-y-8 lg:grid lg:grid-cols-2 lg:gap-8 lg:space-y-0"
                >
              ...
              <div class="space-y-10">
                ...
                <div class="space-y-8 py-16">
                  <div class="space-y-4">
                    ...
                    <div
                      class="w-36 h-10 border bg-namjaibrown rounded-md py-2 text-center"
                    >
